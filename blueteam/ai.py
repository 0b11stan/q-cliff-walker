    ...
    for i in range(0, len(playground)):
        ...
        for j in range(0, len(playground[i])):
            ...
            if 0 <= i - 1 <= len(playground):
                reward_row.append(get_reward_for_cell(playground[i - 1][j]))
            else:
                reward_row.append(0)
            # DOWN
            if 0 <= i + 1 < len(playground):
            ...
            if 0 <= j - 1 < len(playground[i]):
                reward_row.append(get_reward_for_cell(playground[i][j - 1]))
            else:
                reward_row.append(0)
            # RIGHT
            if 0 <= j + 1 < len(playground[i]):
